  ...
  return (
    <div className="flex min-h-screen items-center justify-center p-4 text-white">
      <div className="grid w-full max-w-4xl rounded-3xl bg-white shadow-md md:grid-cols-2">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="text-teal-800 placeholder-teal-700"
                  />
                </div>
              </div>
            </article>
        ...
        {/* Results */}
        <div className="flex flex-col items-center justify-center rounded-3xl rounded-t-none bg-gray-800 p-6 text-center lg:rounded-bl-[50px] lg:rounded-tl-none lg:rounded-tr-3xl">
          {monthlyPayment ? (
            <div className="space-y-4">
              ...
              <motion.div
                ...
                className="rounded-lg border-t-4 border-[#dad830] bg-gray-900 p-6 text-left lg:text-center"
              >
                <div className="mb-4 border-b border-gray-700 pb-4">
                  ...
                  <p
                    ...
                    animate={{ opacity: 1, scale: 1 }}
                    transition={{ duration: 0.3 }}
                    className="text-4xl font-bold text-[#dad830]"
                  >
